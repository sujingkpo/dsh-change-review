				...
				React.createElement("div", { className: "dsdrv-livepanel-head" + (collapsed ? "" : " dsdrv-livepanel-head-open") },
					...
					React.createElement("button", { type: "button", className: "dsdrv-livepanel-collapse", title: collapsed ? "展开" : "折叠", onClick: () => setCollapsed(!collapsed) },
						React.createElement("svg", { width: 13, height: 13, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.5, strokeLinecap: "round", strokeLinejoin: "round" },
							collapsed ? React.createElement("polyline", { points: "6 9 12 15 18 9" }) : React.createElement("polyline", { points: "18 15 12 9 6 15" })))),
...
.dsdrv-livepanel { box-sizing:border-box; width: calc(100% - var(--dsh-composer-side-clearance,16px) - var(--dsh-composer-side-clearance,16px) - var(--dsh-composer-dock-inset,8px) - var(--dsh-composer-dock-inset,8px) - var(--dsh-composer-dock-inset,8px) - var(--dsh-composer-dock-inset,8px)); margin:0 auto; }
.dsdrv-livepanel-card { box-sizing:border-box; width:100%; max-width: calc(var(--dsh-composer-card-max-width,780px) - 4 * var(--dsh-composer-dock-inset,8px)); margin:0 auto; border:1px solid var(--dsw-alias-border-l1, rgba(128,128,128,0.3)); background:var(--dsw-alias-bg-layer-2, #22272e); border-radius:12px; overflow:hidden; }
